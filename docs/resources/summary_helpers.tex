    ...
    \begin{tikzpicture}[remember picture,overlay]
      \node[anchor=south west, xshift=40pt, yshift=150pt] at (current page.south west) {  %# Adjust xshift and yshift as needed.
        \begin{minipage}[t]{0.9\textwidth}  %# Adjust width as needed.
          \raggedright\Large\textbf{Author:} Dallas Novakowski, Ph.D.; Survey and Research Analyst \\[0.0cm]  %# Author name.
          \textbf{Email:} \href{mailto:novakowskid1@cnc.bc.ca}{novakowskid1@cnc.bc.ca} \\[0.2cm]  %# Author email.
          \textbf{Requests and Access to Reports and Data:} Institutional Research and Enrollment Management Sharepoint \\[0.0cm]  %# Institutional site name.
          \textbf{Link:} \url{https://cnccloud.sharepoint.com/sites/InstitutionalResearchEnrolmentManagement/SitePages/Home.aspx}  %# SharePoint site link.
        \end{minipage}
      };
    \end{tikzpicture}
  \end{titlepage}
